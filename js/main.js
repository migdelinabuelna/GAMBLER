...
firstslot.src = display.a 
document.getElementById('photos').appendChild(firstslot) 

const secondslot =  document.createElement('img')
display.b = getRandomImages(); //<-we are calling the get random images function - use () when calling a functio
secondslot.src = display.b //changing the source of the image tag
